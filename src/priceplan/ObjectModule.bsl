...
//
&НаСервере
Функция новПрочитатьJSON(Значение, Стандарт = Истина, ПредставленияСсылок = Ложь) Экспорт 
...
//
&НаСервере
Функция новЗаписатьJSON(Значение, Стандарт = Истина, ПредставленияСсылок = Ложь) Экспорт 
...
Функция jsonЗаписать(Значение, Стандарт, ПредставленияСсылок, Типы, Колонки, Смещение, Отступ, ПереносСтроки, НеПолноеМаскированиеСимволов)
	...
	Возврат jsonЗаписатьСтроку(Значение, Ложь);
...
Функция СформироватьСтрокуJSONИзМассива(Объект)
	...
	Для каждого Элемент Из Объект Цикл
		...
		Если  Элемент = "NULL" Тогда
			...
			СтрокаJSON = СтрокаJSON + СтрЗаменить("null", Символы.НПП, "");
			...
			Если ТипДанных = "Структура" Тогда
				...
				Иначе
					...
					Для Сч = 1 По СтрДлина(ТекстJSON) Цикл
						...
						Если Символ = Символы.ПС ИЛИ Символ = "]" ИЛИ Символ = "}" Тогда
							Поз = Сч;
							Прервать;
						КонецЕсли;
					КонецЦикла;
...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    ПараметрыРегистрации.Вставить("Наименование", "Обработка обмена с ПрайсПлан");
    ПараметрыРегистрации.Вставить("Версия", "1.0");
    ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
    ПараметрыРегистрации.Вставить("Информация", "Обработка обмена с ПрайсПлан");
    ПараметрыРегистрации.Вставить("ВерсияБСП", "1.2.1.4");
    ТаблицаКоманд = ПолучитьТаблицуКоманд();
    ДобавитьКоманду(ТаблицаКоманд,
    "Обработка обмена с ПрайсПлан",
    "1",
    "ОткрытиеФормы",
    Истина,""
    //<Модификатор>
